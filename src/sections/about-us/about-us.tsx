...
export function MeteorsDemo() {
  return (
    <div className=" w-full relative max-w-screen-xl">
      ...
      <div className="relative shadow-xl bg-gray-900 border border-gray-800  px-4 py-4 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start">
        ...
        <p className="font-normal text-xl text-slate-500 m-8 md:mx-4 relative z-50">
          Smridhi Tech was founded in 2023 by Deepak Luthra, an industry veteran
          having more than 29 years of experience and having worked with
          Companies like IBM for more than 16 years along with other ex IBMers
          to support business to achieve their goal through technology by
          embedding right technology from the very beginning and taking
...
const AboutUS = () => {
  return (
    <div
      id="about-us"
      className="z-10 flex flex-col min-h-[16rem] items-center justify-center py-8 bg-white"
    >
      <MeteorsDemo />
